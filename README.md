...
- Track 1 research log: [issue #100](https://github.com/N283T/pxr-iduction-challenge/issues/100)
...
|---|---|---|---|
| Track 1 Activity | Predict pEC50 for blinded compounds | MAE lower is better | See issue #100 and `docs/leaderboards/activity/` |
...
- Track 1 status / decisions: issue #100
