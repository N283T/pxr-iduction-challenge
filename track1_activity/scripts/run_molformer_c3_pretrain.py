...
CKPT_DIR = REPO_ROOT.joinpath("track1_activity", "checkpoints", "molformer_c3_pretrain")
...
def main():
    ...
    print(
        f"  data: {n_total} compounds, log2fc_8p25 valid={n_valid_8}, log2fc_33 valid={n_valid_33}"
    )
